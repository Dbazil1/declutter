    ...
    if not is_authenticated():
        ...
        st.markdown("""
            ...
            <div class="mobile-nav-hint">
                <b>Tip:</b> Tap the hamburger menu <span style="background-color:rgba(0,0,0,0.1);border-radius:50%;padding:4px 8px;margin:0 3px;">☰</span> in the top-left corner for navigation options.
            </div>
